...
from clm.src.utils import permutations

from clm.src.dataloaders.base import default_data_path, ImageResolutionSequenceDataset, ResolutionSequenceDataset, SequenceDataset
...
class SpeechCommands(ResolutionSequenceDataset):
    ...
    def setup(self):
        ...
        from clm.src.dataloaders.datasets.sc import _SpeechCommands
