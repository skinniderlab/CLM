...
from clm.src.utils.train import OptimModule

from clm.src.utils.train import get_logger

log = get_logger(__name__)

# This could be None if the CUDA import fails
from clm.src.ops.vandermonde import log_vandermonde_fast
try:
    import pykeops
    from clm.src.ops.vandermonde import log_vandermonde, log_vandermonde_transpose
    has_pykeops = True
    log.info("Pykeops installation found.")
except ImportError:
    has_pykeops = False
    from clm.src.ops.vandermonde import log_vandermonde_naive as log_vandermonde
    from clm.src.ops.vandermonde import log_vandermonde_transpose_naive as log_vandermonde_transpose
    log.warning(
...
class EMAKernel(OptimModule):
    ...
    This module, together with the main S4 block in clm.src.models.sequence.ss.s4
    ...
    EMA module in clm.src.models.sequence.ss.ema.
