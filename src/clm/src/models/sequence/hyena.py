...
try:
    from clm.src.ops.fftconv import fftconv_ref, fftconv_func 
except ImportError:
    fftconv_func = None
...
from clm.src.utils.config import instantiate, auto_assign_attrs
from clm.src.models.nn import Activation
