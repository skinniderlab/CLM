...
# usage:
# python sh/write-grid-v0-cluster.py
...
OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-cluster"
GRID_FILE = "sh/grids/clm_v0-cluster.txt"
CONFIG_DIR = "sh/grids/clm_v0-cluster"
...
PARAM_SPACE = {
    ...
    "paths.dataset": [
        ...
        f"{INPUT_DIR}/bsm-2m-gt_0_5-bitbirch_random.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-fps_maxmin.csv",
        ...
        f"{INPUT_DIR}/bsm-2m-gt_0_8-pca_grid.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_8-umap_grid.csv",
    ],
