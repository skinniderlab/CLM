...
# usage:
# python sh/write-grid-v0-random.py
...
OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-random"
GRID_FILE = "sh/grids/clm_v0-random.txt"
CONFIG_DIR = "sh/grids/clm_v0-random"
...
PARAM_SPACE = {
    ...
    # paths
    "paths.dataset": [
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k130491-seed1.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k130491-seed2.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k130491-seed3.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k300000-seed1.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k300000-seed2.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k300000-seed3.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k35558-seed1.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k35558-seed2.csv",
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random-k35558-seed3.csv",
    ],
