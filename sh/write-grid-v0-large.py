...
# usage:
# python sh/write-grid-v0-large.py

# cp v0 results
# rsync -av /scratch/tmp/sa7998/clm/v0/hmdb4-deepmet /scratch/tmp/sa7998/clm/v0-large/ --exclude="*_samples.csv.gz" --exclude="*_samples_masses.csv.gz"
# rsync -av /scratch/tmp/sa7998/clm/v0/bsm-train /scratch/tmp/sa7998/clm/v0-large/ --exclude="*_samples.csv.gz" --exclude="*_samples_masses.csv.gz"
# rsync -av /scratch/tmp/sa7998/clm/v0/bsm-2m-gt_0_5 /scratch/tmp/sa7998/clm/v0-large/ --exclude="*_samples.csv.gz" --exclude="*_samples_masses.csv.gz"
# rsync -av /scratch/tmp/sa7998/clm/v0/bsm-2m-gt_0_95 /scratch/tmp/sa7998/clm/v0-large/ --exclude="*_samples.csv.gz" --exclude="*_samples_masses.csv.gz"
# rsync -av /scratch/tmp/sa7998/clm/v0-cluster/bsm-2m-gt_0_5-random /scratch/tmp/sa7998/clm/v0-large/ --exclude="*_samples.csv.gz" --exclude="*_samples_masses.csv.gz"
...
BASE_CONFIG = "sh/grids/config_bsm_large.yaml"

OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-large"
GRID_FILE = "sh/grids/clm_v0-large.txt"
CONFIG_DIR = "sh/grids/clm_v0-large"
...
PARAM_SPACE = {
    ...
    "paths.dataset": [
        ...
        f"{INPUT_DIR}/bsm-2m-gt_0_5-random.csv",
    ],
}
...
for combo in itertools.product(*values):
    ...
    # -------------------------
    # avoid excessive enum but use only largest enum avilable
    # -------------------------
