...
# usage:
# python sh/write-grid-v0-model.py
...
OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-model"
GRID_FILE = "sh/grids/clm_v0-model.txt"
CONFIG_DIR = "sh/grids/clm_v0-model"
...
PARAM_SPACE = {
    ...
    # model
    "model_params.model_type": ["RNN", "Transformer", "S4", "H3", "Hyena", "Mamba", "Mamba2", "Mamba3"],
