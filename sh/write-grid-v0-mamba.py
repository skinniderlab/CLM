...
# usage:
# python sh/write-grid-v0-mamba.py
...
BASE_CONFIG = "sh/grids/config_bsm_model.yaml"

OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-mamba"
GRID_FILE = "sh/grids/clm_v0-mamba.txt"
CONFIG_DIR = "sh/grids/clm_v0-mamba"
...
PARAM_SPACE = {
    ...
    # model
    "model_params.model_type": ["Mamba"],
    "model_params.n_layers": [3, 5, 7],
    "model_params.embedding_size": [128, 256, 512],
    "model_params.state_dim": [64, 128],
    "model_params.dropout": [0, 0.1],
    "model_params.learning_rate": [0.0003, 0.001],
}
