...
# usage:
# python sh/write-grid-v0-rnn.py
...
OUT_ROOT = "/scratch/tmp/sa7998/clm/v0-rnn"
GRID_FILE = "sh/grids/clm_v0-rnn.txt"
CONFIG_DIR = "sh/grids/clm_v0-rnn"
...
PARAM_SPACE = {
    ...
    "model_params.embedding_size": [64, 128, 256],
    "model_params.hidden_size": [512, 1024],
    "model_params.n_layers": [2, 3, 5],
